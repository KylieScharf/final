...
## Assumption Checks
  ...
  In order to test our hypothesized relationship, we fit a model to our data. The method we chose is a linear regression model. Before we could fit such a model, we needed to check that all assumptions of the model were met by our data. Below are graphs used to check some of the assumptions. 
