...
We then wanted to assess the different sourced of variability in our model. Below is a table including such sources. 
...
In order to further assess whether a linear model is appropriate or not, we created a new simulated data set that we would expect to see if our data was linear. The plots of both the simulated and observed data are shown below. 
